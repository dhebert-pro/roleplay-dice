...
import IconBrain from '@/components/icons/faces/IconBrain.vue';
import IconEye from '@/components/icons/faces/IconEye.vue';
...
import IconLeaf from '@/components/icons/faces/IconLeaf.vue';
